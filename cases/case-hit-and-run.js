...
(() => {
  ...
  c.scenes = {
    ...
    scene_after_party: {
      ...
      text: 'الساعة قربت من الواحدة بالليل. عزومة "سلمى" لسه لسه خلصت، والصوت لسه رنّان في ودانك — ضحك، موسيقى واطية، ريحة شيشة وقهوة مخلوطة بهوا الليل البارد شوية. مجموعة الأصحاب بتتجمع عند الباب: يوسف بيلعب بمفاتيح عربيته وهو بيضحك على نكتة قالها حد، كريم واقف جنبه بيشد في ياقة تيشيرته وكأنه حاسس بحرارة رغم البرد، ونور بتودّع سلمى بحضن سريع وهي بتلمّ شنطتها. مينا، اللي كان بيمزح طول الليلة وصوته أعلى واحد في الأوضة، بيقول "أنا هامشي على رجلي، البيت قريب، ومحتاج هوا" ويبدأ يمشي على الرصيف لوحده وسماعاته في ودانه.',
      inspects: [
        { label: '👀 افحص حالة كريم', detail: 'كريم شرب أكتر من كأس الليلة دي. مش سكران خالص، بس مش في أحسن حالاته، وإيده بترعش شوية وهو بيمسك موبايله.' },
        { label: '👀 افحص عربية يوسف', detail: 'عربية يوسف متلمة قدام البيت مباشرة. مفتاح واحد بس، ويوسف ماسكه في إيده دلوقتي، بيلفه حوالين صباعه بعصبية خفيفة.' },
        { label: '👀 افحص الشارع اللي مينا ماشي فيه', detail: 'شارع سكني هادي، إضاءة ضعيفة من عمود واحد بس على بعد كام متر، ومفيش حد تاني ماشي في نفس الاتجاه.' },
      ],
    ...
    scene_impact: {
      ...
      text: 'مينا لسه ماشي على الرصيف، سماعاته في ودانه وهو بيهمهم مع الأغنية، مش واخد باله من صوت المحرك اللي بيقرب من وراه بسرعة غريبة. فجأة، العربية بتنحرف من مسارها الطبيعي وتصدمه بقوة. صوت الصدمة بيقطع هدوء الشارع فجأة، وصوت جسمه وهو بيقع على الرصيف بيسمعه أي حد قريب. العربية توقف لحظة — ثانية واحدة بس، كإن حد جواها بيتردد — وبعدين تكمل طريقها بسرعة جنونية وتختفي في نهاية الشارع المظلم، من غير ما تسيب حتى فرصة لحد يشوف وشها كامل.',
      inspects: [
        { label: '👀 افحص أثر الفرملة', detail: 'مفيش أثر فرملة واضح على الأسفلت. يعني السواق ماحاولش يوقف أصلًا، ولا حتى في اللحظة الأخيرة قبل الصدمة.' },
        { label: '👀 لاحظ توقف العربية اللحظي', detail: 'الثانية اللي وقفت فيها العربية بعد الصدمة غريبة — كأن السواق اتصدم من اللي عمله، مش خطة مرسومة من الأول.' },
      ],
    ...
    scene_bystanders: {
      ...
      text: 'خلال ثواني، الشارع اتملى بالناس. حد بيتصل بالإسعاف بصوت مرتجف، حد تاني بيحاول يهدي مينا اللي بقى واعي بس متألم جدًا ومش قادر يتحرك، وبيكرر "رجلي... مش حاسس برجلي" بصوت خافت. "أحمد"، صاحب محل قريب كان بيقفل شيش المحل، شاف اللحظة كاملة من بعيد وقدر يحفظ جزء من رقم اللوحة قبل ما العربية تختفي في الضلمة. الإسعاف بتوصل بعد دقايق قليلة حسّيتها طويلة أوي، ومينا بيتنقل على طول للمستشفى وسط صوت السيرينة.',
      inspects: [
        { label: '👀 اسأل أحمد إيه اللي شافه بالظبط', detail: '"شفت العربية بتتحرك بسرعة غريبة قبل الصدمة كإنها مش ماشية عادي، والسواق كان لابس حاجة فاتحة اللون — ده أكتر حاجة قدرت ألاحظها من بعيد كده."' },
        { label: '👀 اسأل أحمد ليه واقف برّه المحل الساعة دي', detail: '"كنت بقفل الشيش عشان أمشي، والصدفة إني كنت لسه واقف على الرصيف بره لما سمعت الصوت."' },
      ],
    ...
    scene_hospital_mina: {
      ...
      text: 'وصلت المستشفى بعد الإسعاف بشوية. رايحة المطهرات والضوء الأبيض القوي في الممرات بيدوا إحساس ثقيل. مينا في حالة مستقرة، كسور بس مش خطر على حياته. عينيه نصفهم مفتوحة من تأثير المسكنات، بس لسه قادر يتكلم. "معرفش مين كان بيسوق... كان كل حاجة سريعة أوي..." بيقولها بصوت واطي ومتقطع. أخوه واقف جنب السرير، وشه متغيّر تمامًا من ساعة ما وصل، وبيبص لك بعينين بيطلبوا منك حاجة واحدة بس: الحقيقة.',
      inspects: [
        ...
        { label: '👀 اسأل الدكتور المناوب عن حالته', detail: '"إصابات متوسطة، الحمد لله مفيش خطر فعلي على حياته. هيحتاج وقت راحة طويل بس هيتعافى تمامًا."' },
      ],
    ...
    scene_brother_request: {
      ...
      text: 'برّه أوضة مينا، في ممر المستشفى الهادي بالليل، أخوه بيقولك إن الشرطة فتحت محضر بس مش متفائل إنهم هيتحركوا بسرعة كفاية وسط الزحمة اليومية عندهم. "رقم اللوحة الجزئي اللي معانا بيوصل لمجموعة أصحاب مينا اللي كانوا معاه في العزومة الليلة دي. دول ناس بيعرفهم من ثانوي، مش غرباء. عايزك تحقق قبل ما القضية دي تتقفل كـ سواق مجهول وتضيع من غير عدالة." صوته فيه مزيج من التعب والإصرار.',
    ...
    scene_karim_first: {
      ...
      inspects: [
        ...
        { label: '👀 اسأله كان فين وقت الحادثة بالظبط', detail: '"كنت... رايح البيت. مش فاكر التفاصيل بصراحة، الدنيا كانت متأخرة والليلة كلها ضبابية شوية."' },
      ],
    ...
    scene_yousef_first: {
      ...
      text: 'اخترت تتكلم مع يوسف الأول من غير ما تكشف نيتك. قابلته في مكان هادي بعيد عن باقي المجموعة، وسألته عن العربية بشكل عادي كإنك بتسأل سؤال روتيني. "أيوه، العربية دي بتاعتي فعلاً. بس أنا كنت راكب جنب كريم وقت الحادثة، هو اللي كان سايق. كنت تعبان مش عايز أسوق." كلامه هادي ومتماسك، من غير أي علامة توتر ظاهرة، وبيبص في عينيك طول الوقت وهو بيتكلم.',
      inspects: [
        { label: '👀 اسأله ليه سايبه يسوق عربيته', detail: '"كريم صاحبي من زمان، مش أول مرة يسوق عربيتي. مفيش داعي أسوق وأنا تعبان وهو صاحي."' },
        { label: '👀 اسأله عن حالة كريم وقتها', detail: '"كان شرب شوية، بس مش سكران خالص. فكرت إنه قادر يسوق عادي."' },
      ],
      choices: [ { label:'التالي ←', next:'scene_crime_scene' } ],
    },
    ...
    scene_plate_lead: {
      ...
      text: 'راجعت رقم اللوحة الجزئي اللي أحمد سجله مع سجلات المرور، بعيني ملزوقة في الشاشة وأنت بتقارن رقم رقم. النتيجة قاطعة: بيتطابق تمامًا مع عربية يوسف، رقم رقم وحرف حرف، من غير أي مجال للشك. لسه السؤال الأهم فاضل من غير إجابة — مين كان فعلاً قاعد على كرسي السواق وقت الحادثة؟ يوسف، صاحب العربية اللي بيقول إنه كان راكب بس، ولا كريم اللي يوسف بيرميه هو المسؤول؟',
    ...
    scene_nour_testimony: {
      ...
      text: 'نور قابلتك في كافيه هادي بعيد عن المجموعة، شكلها متوتر ومش عايزة تتكلم كتير في الأول. بتلف الكوباية في إيدها وعينها بتتفادى عينيك. "أنا كنت قاعدة ورا، مش شايفة وش السواق كويس. بس..." بتوقف لحظة، وكإنها بتحسب كل كلمة قبل ما تقولها. "قبل الحادثة بلحظات كنت شايفة قميص فاتح اللون من بين الكرسيين. وبعد الحادثة، لما وقفنا بعد أول لفة، حسّيت إن حد اتحرك بسرعة وغيّر مكانه." نور بتحس إنها بتوشي بصاحبها، وده واضح من تردد صوتها وإيديها الباردة على الكوباية.',
      inspects: [
        { label: '👀 اسألها ليه متوترة كده', detail: '"خايفة أضر بحد بريء. بس برضو خايفة أكتر إني أسكت وحد مسؤول يفلت من غير عقاب."' },
        { label: '👀 اسألها لو حد شافها بتلاحظ ده وقتها', detail: '"محدش قال حاجة، الكل كان مركّز على مينا. أنا بس اللي كنت قاعدة في زاوية أقدر أشوف منها."' },
      ],
    ...
    scene_check_taxi: {
      ...
      text: 'كريم قدّم إيصال تطبيق توصيل كإثبات إنه رجع البيت بتاكسي بعيد عن مكان الحادثة، وهو بيوريهولك على موبايله بثقة زايدة شوية. راجعت الإيصال بالتفصيل — التوقيت، المكان، كل حاجة، بعين محقق مش بعين حد بيصدق أول حاجة تتقال له.',
      inspects: [
        ...
        { label: '👀 اسأله يفسر الفجوة الزمنية', detail: '"كنت ماشي شوية الأول، عايز هوا... معرفش أعمل تايم لاين دقيق بصراحة."' },
      ],
    ...
    scene_camera: {
      ...
      text: 'جمعت كاميرا محل قريب من مكان الحادثة مع كاميرا تانية عند مكان العزومة قبلها بدقايق، وقعدت تقارن الفريمات جنب بعض على الشاشة. المقارنة بتوضح كل حاجة: كريم كان لابس قميص فاتح اللون في كاميرا العزومة — نفس وصف السواق وقت الحادثة اللي قاله أحمد — بينما يوسف كان لابس قميص غامق واضح. مع شهادة نور عن تبديل الأماكن بعد أول لفة، الصورة كاملة اتوضحت قدامك أخيرًا: كريم هو اللي كان بيسوق فعلاً.',
      inspects: [
        { label: '👀 دقق في تفاصيل القميص', detail: 'نفس القميص بالظبط — نفس اللون، نفس القصة. مفيش مجال للشك في التطابق ده.' },
        { label: '👀 راجع توقيت الكاميرتين', detail: 'الفاصل الزمني بين الكاميرتين متوافق تمامًا مع مسافة القيادة من بيت العزومة لمكان الحادثة.' },
      ],
    ...
    scene_hospital_followup: {
      ...
      text: 'رجعت لمينا في أوضته، اللي بقت أهدأ شوية عن ليلة الحادثة، وقولته إنك عرفت مين كان بيسوق. عينيه اتلمعت بدموع مكتومة، وهو بيحاول يستوعب اللي سامعه. "كريم؟ إحنا أصحاب من الثانوي..." صوته اتكسر شوية، وسكت لحظة قبل ما يكمل. "بس شكرًا إنك ماسبتش الموضوع يعدي كده." اللحظة دي خلتك تحس بوزن المسؤولية اللي على كتفك أكتر من أي وقت في القضية.',

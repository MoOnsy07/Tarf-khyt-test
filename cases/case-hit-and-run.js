...
/* ============================================================
   وضع القصة التفاعلية (Story Mode) — نظام جديد كليًا، 2026-08-30
   بناءً على طلب صريح: القضية دي بتستبدل تابات الاستجواب/الأدلة/
   الألغاز بالكامل بمشاهد متتالية، كل قرار فيها بيوديك لمشهد مختلف
   فعليًا (تفرع حقيقي)، مع نقط تقابل بين المسارات عشان العدد يفضل
   قابل للكتابة. لو CASE.storyMode=true، المحرك بيشتغل بالكامل من
   خلال الغرافة دي بدل mountGameShell التقليدي.
   ============================================================ */
(() => {
  const c = CASE_HIT_AND_RUN;
  c.storyMode = true;
  ...
  c.scenes = {
    scene_after_party: {
      ...
      label: 'بعد العزومة',
      text: 'مجموعة أصحاب بيخرجوا من عزومة متأخرة بالليل، ضحك وحركة عادية، وسيارة واحدة بس بتاخد أكتر من واحد منهم.',
      choices: [ { label:'التالي ←', next:'scene_accident' } ],
    },
    scene_accident: {
      img: IMG_BASE_HITRUN + 'hitrun-scene2.jpg',
      label: 'الحادثة',
    ...
    scene_bystanders: {
      img: IMG_BASE_HITRUN + 'hitrun-scene3.jpg',
      label: 'بعد الحادثة',
      text: 'ناس المنطقة بتتجمع حوالين مينا وبتتصل بالإسعاف. حد من الشهود بيلاحظ رقم لوحة العربية جزئيًا قبل ما تختفي في الضلمة. أخو مينا طلب منك تحقق في الموضوع.',
    ...
    scene_decision1: {
      img: IMG_BASE_HITRUN + 'hitrun-scene4.jpg',
      label: 'قبل ما تبدأ',
      text: 'رقم اللوحة الجزئي بيوصل لمجموعة أصحاب كانوا في نفس العزومة. تدخل عليهم بصرامة وتواجه كريم على طول، ولا تكلم يوسف الأول من غير ما تكشف نيتك؟',
      choices: [
    ...
    scene_karim_first: {
      ...
      label: 'مواجهة كريم',
      text: 'واجهت كريم على طول برقم اللوحة. اتوتر فورًا وقال "العربية دي مش بتاعتي، ده يوسف صاحبها". حسّيت إن رد فعله فيه حاجة مش مطمّنة.',
      choices: [ { label:'التالي ←', next:'scene_plate_lead' } ],
    },
    scene_yousef_first: {
      img: IMG_BASE_HITRUN + 'yousef.jpg',
      label: 'كلام مع يوسف',
      text: 'اتكلمت مع يوسف بهدوء الأول. قالك إن العربية بتاعته فعلاً، بس هو كان راكب جنب كريم وقت الحادثة، وكريم هو اللي كان سايق. كلامه هادي ومنطقي.',
      choices: [ { label:'التالي ←', next:'scene_plate_lead' } ],
    },
    ...
    scene_plate_lead: {
      ...
      label: 'رقم اللوحة',
      text: 'رقم اللوحة الجزئي بيتطابق تمامًا مع عربية يوسف. لسه مش واضح مين كان فعلاً السواق وقت الحادثة — يوسف صاحب العربية، ولا كريم اللي يوسف بيقول إنه كان سايقها.',
    ...
    scene_decision2: {
      ...
      label: 'شهادة نور',
      text: 'نور، صديقة المجموعة اللي كانت راكبة في الكرسي الخلفي، قالت إن السواق وقت الحادثة كان لابس قميص فاتح، وإن حد بدّل مكانه مع يوسف بعد ما وقفوا بعد أول لفة. كريم بينكر ركوبه العربية من الأساس.',
      choices: [
    ...
    scene_check_taxi: {
      ...
      label: 'إيصال التاكسي',
      text: 'الإيصال اللي قدمه كريم حقيقي، لكن الرحلة بدأت بعد الحادثة بحوالي ساعة، ومن مكان مختلف عن العزومة. يعني الإيصال ما يثبتش إنه كان بعيد وقت الصدمة.',
      choices: [ { label:'التالي ←', next:'scene_camera' } ],
    },
    scene_confront_karim: {
      img: IMG_BASE_HITRUN + 'karim.jpg',
      label: 'مواجهة مباشرة',
      text: 'واجهت كريم بالتناقض بين كلامه وشهادة نور. اتلخبط في كلامه شوية، لكن لسه مصمم إنه ماركبش العربية أصلًا.',
      choices: [ { label:'التالي ←', next:'scene_camera' } ],
    },

    scene_camera: {
      img: IMG_BASE_HITRUN + 'ahmed.jpg',
      label: 'مقارنة الكاميرات',
      text: 'كاميرا محل قريب من مكان الحادثة، بمقارنتها بكاميرا عند مكان العزومة قبلها بوقت قصير، بتأكد إن كريم كان لابس القميص الفاتح — نفس لبس السواق وقت الحادثة — ويوسف كان لابس قميص غامق. مع شهادة نور عن تبديل الأماكن، الصورة اتوضحت: كريم هو اللي كان بيسوق.',
      choices: [ { label:'التالي ←', next:'scene_decision3' } ],
    },

    scene_decision3: {
      img: IMG_BASE_HITRUN + 'karim.jpg',
      label: 'قبل ما تقفل القضية',
      text: 'عندك الصورة كاملة دلوقتي: كريم هو السواق الحقيقي، وحاول يلصق التهمة بيوسف. تواجهه قدام المجموعة كلها علنًا، ولا تاخده على جنب وتخليه يعترف بهدوء؟',
      choices: [
    ...
    ending_good_public: {
      ...
      title: 'عدالة علنية',
      paragraphs: [
        'واجهت كريم بكل الأدلة قدام المجموعة كلها: رقم اللوحة، شهادة نور عن تبديل الأماكن، ومقارنة الكاميرات اللي أثبتت إنه كان لابس القميص الفاتح وقت الحادثة. انهار واعترف قدام أصحابه إنه هو اللي كان بيسوق، وإنه حاول يلصق التهمة بيوسف من الخوف.',
        'يوسف اتبرأ قدام الكل في نفس اللحظة، من غير ما يفضل في دايرة الشك، ومينا وأهله عرفوا الحقيقة كاملة.',
      ],
    },
    ending_good_private: {
      isEnding: true,
      ...
      title: 'عدالة خاصة',
      paragraphs: [
        'خدت كريم على جنب وواجهته بالأدلة من غير ما تحرجه قدام المجموعة. اعترف بهدوء إنه هو اللي كان بيسوق، وإنه حاول يلصق التهمة بيوسف من الخوف.',
        'براءة يوسف وصلت للمجموعة عن طريق التقرير الرسمي بدل مواجهة علنية مباشرة. النتيجة نفس الحقيقة، لكن بطريقة أهدأ على الجميع.',
      ],
    },
    ending_bad: {
      isEnding: true,
      ...
      paragraphs: [
        'اتهمت يوسف بناءً على ملكية العربية بس، من غير ما تتحقق من شهادة نور أو كاميرات المقارنة. يوسف كان بريء فعليًا — كريم هو اللي كان بيسوق الليلة دي، وفضل طليق من غير أي مساءلة.',
        'الأدلة كانت بتشاور بوضوح على اتجاه تاني، لكن السرعة في الاتهام فوّتت الفرصة الحقيقية للعدالة.',
      ],
    },
  };
})();
